...
const StudentProfile = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto p-4 md:p-8 space-y-12 animate-in zoom-in duration-700">
            {profiles.map((profile, index) => (
                <div key={profile.id} className="bg-white rounded-[3rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] overflow-hidden border border-gray-100 ring-1 ring-black/5">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
                            ...
                            <div className="text-center md:text-left">
                                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest border border-white/10 mb-4">
                                    <ShieldCheck size={14} className="text-emerald-400" /> Dossier #{index + 1}
                                </div>
                    ...
                    <div className="p-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                        <div className="space-y-10 lg:col-span-1">
                            <div className="relative">
                                ...
                                <h2 className="text-xs font-black text-primary uppercase tracking-[0.3em] bg-white relative inline-block pr-6 z-10">Identity Details</h2>
                            </div>
                        ...
                        <div className="space-y-10 lg:col-span-2">
                            <div className="relative">
                                <div className="h-0.5 w-full bg-gray-100 absolute top-4"></div>
                                <h2 className="text-xs font-black text-indigo-600 uppercase tracking-[0.3em] bg-white relative inline-block pr-6 z-10">Communication Vault</h2>
                            </div>
