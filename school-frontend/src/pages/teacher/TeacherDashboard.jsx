        ...
        <div className="flex h-screen bg-gray-50">
            <aside className="w-64 bg-white border-r shadow-sm hidden md:flex flex-col">
                ...
                <nav className="flex-1 p-4 space-y-2">
                    <a href="#" className="flex items-center gap-3 px-4 py-3 bg-secondary bg-opacity-10 text-secondary rounded-xl font-medium"><Activity size={20} /> Overview</a>
                    ...
                    <a href="#" className="flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-xl"><FileText size={20} /> Assignments</a>
                </nav>
