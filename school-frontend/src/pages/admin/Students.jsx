                                ...
                                <tr key={s.id} className="hover:bg-primary/[0.02] transition-colors group">
                                    ...
                                    <td className="px-10 py-6 text-right">
                                        <div className="flex justify-end gap-3 translate-x-4 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">
                                            <button onClick={() => handleEdit(s)} className="p-3.5 text-indigo-600 hover:bg-indigo-50 rounded-2xl transition-all shadow-sm bg-white border border-indigo-100"><Edit size={20} /></button>
                                            <button onClick={() => handleDelete(s.id)} className="p-3.5 text-red-600 hover:bg-red-50 rounded-2xl transition-all shadow-sm bg-white border border-red-100"><Trash2 size={20} /></button>
                                        </div>
                                    </td>
                                </tr>
                            ))}
